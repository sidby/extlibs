namespace Trirand.Web.Mvc
{
    ...
    internal class JQTreeViewRenderer
    {
        ...
        private string GetStandaloneJavascript()
        {
            ...
            builder.AppendFormat("<div id='{0}_wrapper' class='ui-widget ui-jqtreeview-wrapper' style='width:{1}; height:{2};'>", this._model.ID, this._model.Width.ToString(), this._model.Height.ToString());
            ...
            builder.Append("<div style='position:absolute;top:-9999px; left:-9999px;'>");
            builder.AppendFormat("<a href='#' id='{0}' tabindex='1'>dsdsa</a>", this._model.ID + "_accessLink");
            builder.Append("</div>");
