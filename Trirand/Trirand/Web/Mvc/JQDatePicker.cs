namespace Trirand.Web.Mvc
{
    ...
    public class JQDatePicker
    {
        ...
        /// <summary>
        /// Function name triggered onSelect event of datepicker
        /// this used to raise triggerToolbar event of gview 
        /// example of function:
        /// function FunctionName(dateText, inst) { $("#GridViewId")[0].triggerToolbar(); }
        /// </summary>
        public string OnSelectedCallbackFunction { get; set; }
